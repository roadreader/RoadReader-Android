...
public class MyUploadService extends MyBaseTaskService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_UPLOAD.equals(intent.getAction())) {
            ...
            String videoPath = intent.getStringExtra(EXTRA_FILE_PATH);
            ...
            */
            ...
            uploadFromUri(fileUri, videoPath);
        }
    ...
    private void uploadFromUri(final Uri fileUri, final String videoPath) {
        ...
        // [START get_child_ref]
        final StorageReference vidRef = mStorageRef.child(videoPath);
        StorageMetadata metadata = new StorageMetadata.Builder().build();

        // [END get_child_ref]

        // Upload file to Firebase Storage
        Log.d(TAG, "uploadFromUri:dst:" + vidRef.getPath());
        vidRef.putFile(fileUri).
